...
public class TestSuite {
	...
	private static void initTestProcesses() {
		...
		*/
		...
		testProcesses.add(new ProcessDescription(100, 800));
		testProcesses.add(new ProcessDescription(200, 650));
		testProcesses.add(new ProcessDescription(300, 500));
		testProcesses.add(new ProcessDescription(400, 700));
		testProcesses.add(new ProcessDescription(500, 500));
		testProcesses.add(new ProcessDescription(600, 300));
